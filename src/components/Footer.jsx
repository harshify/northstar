      ...
      <div className="container">
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
            ...
            <a href="#" style={{ color: 'var(--text-secondary)', transition: 'color 0.3s' }} onMouseEnter={e => e.currentTarget.style.color='var(--accent-secondary)'} onMouseLeave={e => e.currentTarget.style.color='var(--text-secondary)'} aria-label="Instagram">
